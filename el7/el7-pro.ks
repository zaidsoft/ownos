...
# Root password
# use below line to generate crypted password and put it in rootpw line
# perl -e 'print crypt("password","salt")."\n";'
rootpw --iscrypted !PUT_ENC_PASSWORD_HERE


#repo --name=base --baseurl=file:///d/ownos/el7/pkgs/base --excludepkgs=grubby
...
repo --name=epel2 --baseurl=http://ftp.riken.jp/Linux/fedora/epel/7/x86_64/
